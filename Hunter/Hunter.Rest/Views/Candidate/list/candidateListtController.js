(function() {
    ...
    function CandidateListController($location, $filter, authService, candidateHttpService) {
        ...
        function fake() {
            ...
            vm.candidateList[2].pools.push({ 'name': '.NET' });
            vm.candidateList[3].pools.push({ 'name': 'JS' });
            vm.candidateList[4].pools.push({ 'name': 'JS' });
            vm.candidateList[5].pools.push({ 'name': 'JS' });
            vm.candidateList[6].pools.push({ 'name': 'PHP' });
            vm.candidateList[7].pools.push({ 'name': 'PHP' });
            vm.candidateList[8].pools.push({ 'name': 'PHP' });
            vm.candidateList[9].pools.push({ 'name': 'QA' });
            vm.candidateList[10].pools.push({ 'name': 'QA' });
            vm.candidateList[11].pools.push({ 'name': 'QA' });
            vm.candidateList[12].pools.push({ 'name': '.NET' });
            vm.candidateList[13].pools.push({ 'name': '.NET' });
            vm.candidateList[14].pools.push({ 'name': '.NET' });
